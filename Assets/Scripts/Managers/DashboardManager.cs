...
public class DashboardManager : MonoBehaviour
{
    ...
    [SerializeField] string DEFAULT_TIME_OF_GOAL = "";
    ...
    {
        logoPathInput.text = DEFAULT_LOGO_PATH;
        bgPathInput.text = DEFAULT_BG_PATH;
        celebBGPathInput.text = DEFAULT_CELEB_BG_PATH;
    }
