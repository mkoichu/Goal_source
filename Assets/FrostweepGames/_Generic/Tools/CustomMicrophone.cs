...
namespace FrostweepGames.Plugins.Native
{
	public sealed class CustomMicrophone
	{
...
#endif
			GameFlowStates.state = PossibleGameFlowStates.MicrophoneLoaded;
            Debug.Log("===================== CUSTOM MICROPHONE LOADED =====================");
		}
		...
		public static AudioClip Start(string deviceName, bool loop, int lengthSec, int frequency)
		{
			...
			Debug.Log($"WEBGL - START RECORDING: {deviceName}      deviceID: {deviceId}");
...
#if UNITY_WEBGL && !UNITY_EDITOR && FG_MPRO
			string deviceId = FrostweepGames.MicrophonePro.Microphone.Instance.GetDeviceIdByName(deviceName);
			Debug.Log($"WEBGL - IS RECORDING: {deviceName}   deviceID: {deviceId}");
